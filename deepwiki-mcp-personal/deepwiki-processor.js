...
async function initializeModules() {
  try {
    // 导入核心模块
    const crawlerModule = await import('./dist/lib/httpCrawler.mjs');
    const converterModule = await import('./dist/converter/htmlToMarkdown.mjs');
    const resolveModule = await import('./dist/utils/resolveRepoFetch.mjs');
    const extractModule = await import('./dist/utils/extractKeyword.mjs');
    const schemaModule = await import('./dist/schemas/deepwiki.mjs');
